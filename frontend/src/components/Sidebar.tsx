...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="h-full w-64 fixed left-0 top-0 bg-[#0b1326] flex flex-col py-8 px-4 z-50">
        ...
        <div className="mt-auto space-y-1 pt-6 border-t border-outline-variant/10">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 mb-6 bg-linear-to-br from-primary to-primary-container text-on-primary rounded-xl font-bold text-sm transition-transform active:scale-95 shadow-lg shadow-primary/10"
          >
      ...
      <NewEndpointModal open={modalOpen} onClose={() => setModalOpen(false)} />
    </>
  );
}
